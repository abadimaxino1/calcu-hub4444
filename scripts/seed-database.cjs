...
// Run with: node scripts/seed-database.cjs
...
## الاستقالة مقابل إنهاء العقد

| الحالة | أقل من سنتين | 2-5 سنوات | 5-10 سنوات | أكثر من 10 سنوات |
|--------|-------------|-----------|------------|-----------------|
| إنهاء العقد | كامل | كامل | كامل | كامل |
| الاستقالة | لا شيء | ثلث | ثلثين | كامل |
